        ...
        `}>
            <div className="w-[90%] lg:w-4/5">
                <Grid sm={2} md={4} lg={8}>
                    ...
                    <div className="h-24 w-full bg-orange-500">#2</div>
                    <div className="h-24 w-full bg-red-500">#3</div>
                    <div className="h-24 w-full bg-purple-500">#4</div>
                    <div className="h-24 w-full bg-blue-500">#5</div>
                    <div className="h-24 w-full bg-green-500">#6</div>
                    <div className="h-24 w-full bg-yellow-500">#7</div>
